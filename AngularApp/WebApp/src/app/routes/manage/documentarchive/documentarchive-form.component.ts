...
@Component({
    ...
    templateUrl: './documentarchive-form.component.html',
    styleUrls: ['./documentarchive.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [DocumentArchiveService],
})
export class CreateDocumentArchiveComponent {
    fileBaseUrl: any;
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<CreateDocumentArchiveComponent>,
