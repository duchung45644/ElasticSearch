...
@Component({
    ...
    templateUrl: './view-canceledapprove.component.html',
})
export class ViewApproveComponent {
    fileBaseUrl: any;
    approve: Approve;
    approveList: any;
    list = [];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ViewApproveComponent>,
    ...
    getallrecord() {
        ...
        this.approve = new Approve();
        this.approveService
            .GetAllRecordStatus({ Id: this.viewId, RecordId: this.record.RecordId, Status: 4 })
            .subscribe((data: any) => {
